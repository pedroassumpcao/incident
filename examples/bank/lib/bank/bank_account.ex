defmodule Bank.BankAccount do
  ...
  alias Bank.Commands.{DepositMoney, OpenAccount, ReceiveMoney, SendMoney, WithdrawMoney}
  alias Bank.Events.{AccountOpened, MoneyDeposited, MoneyReceived, MoneySent, MoneyWithdrawn}
