...
config :incident, :event_store, adapter: Incident.EventStore.InMemory.Adapter

config :incident, :projection_store, adapter: Incident.ProjectionStore.InMemory.Adapter
